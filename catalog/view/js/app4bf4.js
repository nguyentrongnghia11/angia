import { scrollStay, Waves, Patterns } from "../js/modules/main.js";
import {
  buttonEF,
  FocusText,
  Reset,
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const isNormalScrollPage =
    ...
    document.querySelector("#facilities-page") ||
    document.querySelector("#apartment-page") ||
  ...
  if (isNormalScrollPage) {
    ...
    style.innerHTML = `
            html.normal-scroll, body.normal-scroll {
                height: auto !important;
                overflow-x: hidden !important;
                overflow-y: auto !important;
            }
            .normal-scroll .box-slider {
                height: auto !important;
  ...
  navButtons.forEach((button, index) => {
    ...
    button.addEventListener("click", (e) => {
      ...
      const targetSection = page
        ? document.querySelector(`.group-central[data-name="${page}"]`)
        : sections[index];
      if (targetSection) {
        targetSection.scrollIntoView({ behavior: "smooth" });
      } else {
        const href = btnClick
          ? btnClick.getAttribute("data-href") || btnClick.getAttribute("href")
          : null;
        if (href) {
  ...
  function _runNavUpdate() {
    ...
    if (activeSection) {
      const name = activeSection.getAttribute("data-name");

      // Generic match: find button with matching data-page
      const matchingBtn = Array.from(navButtons).find((btn) => {
        const clickBtn = btn.querySelector(".click");
        return clickBtn && clickBtn.getAttribute("data-page") === name;
      });
      if (matchingBtn) {
        targetNavIndex = Array.from(navButtons).indexOf(matchingBtn);
      } else {
        // Fallback for custom group mappings
...
var isFirst = 0;
function changeUrl(e, t, o, s, a, n, r) {
  if (e) {
    e = e.replace(/^https?:\/\/[^\/]+/g, window.location.origin);
  }
...
function changeAlternate(e, t, o) {
  if (null !== t) {
    var origin = window.location.origin;
    if (void 0 !== o) {
      var hrefvi = t.dataset.hrefvi
        ? t.dataset.hrefvi.replace(/^https?:\/\/[^\/]+/g, origin)
        : "";
      var hrefen = t.dataset.hrefen
        ? t.dataset.hrefen.replace(/^https?:\/\/[^\/]+/g, origin)
        : "";
      document.querySelector('link[hreflang="vi-vn"]') &&
        document
          .querySelector('link[hreflang="vi-vn"]')
          .setAttribute("href", hrefvi);
      document.querySelector('link[hreflang="en-us"]') &&
        document
          .querySelector('link[hreflang="en-us"]')
          .setAttribute("href", hrefen);
    } else {
      t.forEach(function (e) {
        var val = e.innerHTML
          ? e.innerHTML.replace(/^https?:\/\/[^\/]+/g, origin)
          : "";
...
var removeURL = function () {
  var e = document.querySelector(".nav-item.current a").href,
    ...
    o = document.querySelector(".nav-item.current a").dataset.keyword,
    s = document.querySelector(".nav-item.current a").dataset.description;
  changeUrl(
    e,
    t,
    s,
    ...
    var s =
      ...
      n =
        null != e.dataset.description
          ...
          : e.parentElement.querySelector(".link-change-url").dataset
            .description;
    changeUrl(o, s, n, a, e.dataset.name, s, n);
  };
function onScroll() {
  document.querySelectorAll(".ani-item, .wrap-logo").forEach(function (e) {
    isInViewport(e)
      ? e.classList.add("on-show", "on-view")
      : e.classList.remove("on-view");
  });
}
function NavClick() {
  (gsap.set(".main-menu .link-hoz", { yPercent: 100 }),
    gsap.set(".icon", { opacity: 0 }),
    navClick.addEventListener("click", function (e) {
      if (
        (e.preventDefault(),
          gsap.set(".nav", { scrollTop: 0 }),
          bgCanvas && Wave.Pause(),
          !Mobile.matches)
      ) {
        var t = document.querySelector(".box-nav-button.current").dataset.index;
        (o = document.querySelector(".home-video.show-text")) &&
          o.querySelector(".player-vid").click();
      }
      if (navClick.classList.contains("active"))
        (overlayMenu.classList.remove("show"),
          navClick.classList.remove("active"),
          HTML.classList.remove("no-scroll"),
          Body.classList.remove("no-scroll", "dark-color"),
          Header.classList.remove("activemenu"),
          homePage,
          rightHeader.classList.remove("normal"),
          homePage && !Mobile.matches
            ? 0 == t
              ? Glwave1.append(bgCanvas)
              : 4 == t
                ? Glwave2.append(bgCanvas)
                : 6 == t && Glwave3.append(bgCanvas)
            : homePage && Mobile.matches && Glwave1.append(bgCanvas),
          locationPage &&
          !Mobile.matches &&
                  ...
                  onComplete: function () {
                    (homePage && !Mobile.matches
                      ? 0 == t || 4 == t
                        ? Wave.Play()
                        : Wave.Pause()
                      : homePage && Mobile.matches && Wave.Play(),
                      locationPage &&
                      !Mobile.matches &&
                      document
                      ...
                      !Mobile.matches &&
                      document
                        .querySelector(".brochure-library")
                        .classList.contains("show-text") &&
                      Wave.Play(),
                      (newsPage || document.querySelector(".news")) &&
                      !Mobile.matches &&
        ...
        if (
          (Navigation.classList.add("show"),
            ...
            Body.classList.add("no-scroll", "dark-color"),
            HTML.classList.add("no-scroll"),
            Header.classList.add("activemenu"),
            rightHeader.classList.add("normal"),
            menuCanvas || overlayMenu.prepend(bgCanvas),
            gsap.set(".nav", { scrollTop: 0 }),
            gsap.to(".active-nav", {
              duration: 0.3,
              scale: 0,
          ...
          (o = document.querySelector(".home-video.show-text")) &&
            o.querySelector(".onstream") &&
            StopPlay();
        }
        (gsap
          .timeline()
          .to(".main-menu .link-hoz", {
            duration: 1,
            yPercent: 0,
            ease: "expo.out",
            stagger: 0.05,
    ...
    document
      .querySelectorAll(".link-home, .link-load, .view-detail, .view-more")
      .forEach(function (e) {
  ...
  var e = document.querySelector(".register .close");
  Subscribe &&
    (Subscribe.addEventListener("click", function (t) {
      if (
        ...
        var o = document.querySelector(".home-video.show-text");
        (o &&
          o.querySelector(".onstream") &&
          (o.querySelector(".player-vid").click(),
            o.querySelector(".box-video-center").classList.add("onstream")),
          new colEffect(Register));
      }
      setTimeout(function () {
        (document
          .querySelector(".register-form .text-ani-item")
          .classList.add("show"),
      ...
      e.addEventListener("click", function (t) {
        if (
          (t.preventDefault(),
            ...
            registerPopup.classList.remove("show", "enable"),
...
window.onChangeLanguage = function (e, t) {
  if (
    (document.getElementById("language_code").setAttribute("value", e),
  ...
  if ("vi" == document.getElementById("language_code").getAttribute("value"))
    var o = document
      .querySelector('link[hreflang="vi-vn"]')
      .getAttribute("href");
  else
    o = document.querySelector('link[hreflang="en-us"]').getAttribute("href");
  return (
    document.getElementById("changlanguage_redirect").setAttribute("value", o),
    (document.location = o),
    !1
  );
};
...
var librarySlide = function () {
  ...
  logoSlide = function () {
    var e = new Splide(".slide-logo", {
      ...
      afterTrace: !0,
      breakpoints: {
        580: { focus: 0, arrows: !1, pagination: !0, perPage: 2 },
        1100: { focus: 0, arrows: !1, pagination: !0, perPage: 3 },
      },
    });
    (e.on("resize", function () {
      (optionLogo(e.root), e.refresh());
    }),
...
function LoadProgress(e, t) {
  (document.querySelector(".progress-list .scrollD") &&
    (document.querySelector(".progress-list").innerHTML = ""),
    (document.querySelector(".progress .title-main h2").innerHTML = t),
    document
      .querySelector(".progress .title-main h2")
      .classList.remove("show"));
  ...
  (o.open("GET", e, !0),
    (o.onreadystatechange = function () {
      4 == o.readyState &&
        200 == o.status &&
        ((document.querySelector(".progress-list").innerHTML = (function () {
          var parser = new DOMParser();
          var doc = parser.parseFromString(o.responseText, "text/html");
          var loadedContent = doc.querySelector(".progress-list");
          return loadedContent ? loadedContent.innerHTML : o.responseText;
        })()),
          setTimeout(function () {
...
function NewsLoad(e) {
  document.querySelector(".news-content .news-text") &&
  ...
  (t.open("GET", e, !0),
    (t.onreadystatechange = function () {
      if (4 == t.readyState && 200 == t.status) {
        ((document.querySelector(".news-content").innerHTML = (function () {
          var parser = new DOMParser();
          var doc = parser.parseFromString(t.responseText, "text/html");
          var loadedContent = doc.querySelector(".news-content");
          return loadedContent ? loadedContent.innerHTML : t.responseText;
        })()),
          document.querySelector(".zalo-share-button") &&
          ZaloSocialSDK.reload(),
          changeAlternate(e, document.querySelectorAll(".alternate-hl-news")));
        var o = document.querySelectorAll(".news-text p > img");
        o &&
          o.forEach(function (e, t) {
            var o = e.parentNode,
              s = e.parentNode.nextElementSibling,
              a = document.createElement("figure");
            if (
              ((a.className = "figure-img"),
                e.parentNode.parentNode.replaceChild(a, o),
                a.append(e),
                "EM" == s.tagName)
            ) {
              var n = s.textContent;
              a.append(s);
              var r = document.createElement("figcaption");
              ((r.className = "figcaption"),
                (r.innerHTML = n),
                a.replaceChild(r, s));
            }
          });
        var s = document.querySelectorAll(".news-text iframe");
        if (s.length > 0) {
          var a =
            document.querySelector(".news-text iframe").parentNode.offsetWidth;
          s.forEach(function (e) {
            (e.setAttribute("scrolling", "no"),
              e.setAttribute("allowfullscreen", "true"),
              e.setAttribute("frameborder", 0),
              Mobile.matches
                ? (e.style.height = 0.5625 * a + "px")
                : (e.style.height = 0.5625 * (a - 40) + "px"));
          });
        }
        (document
          .querySelectorAll(".news-text a, .news-text p a")
          .forEach(function (e) {
            e.addEventListener("click", function (e) {
              e.preventDefault();
              var t = this.href;
          ...
          document.querySelectorAll(".news-text p").forEach(function (e) {
            var t = e.textContent;
            t && t.length <= 1 && e.classList.add("height-zero");
          }),
          document.querySelectorAll(".share-facebook").forEach(function (e) {
            buttonEF && new buttonEF(e);
          }),
          document.querySelectorAll(".news-text img").forEach(function (e) {
            Mobile.matches && e.classList.add("zoom-pic");
          }),
          ZoomPic(),
          ShareSocial(),
          checkWidth(),
        ...
        for (
          var r = document.querySelector(".link-page.current"), c = 0;
          c < n.length;
          c++
        )
          if (n[c] == r) {
        ...
        (gsap.to(".news-content", {
          ...
          document
            .querySelector(".more-news")
            .addEventListener("click", function () {
              (addURL(
                document.querySelector(".main-menu li.active a"),
                document
                  .querySelector(".main-menu li.active a")
                ...
                changeAlternate(
                  ...
                  document.querySelector(
                    ".main-menu li.active .link-change-url",
                  ),
                  1,
                ),
                document.querySelectorAll(".link-page").forEach(function (e) {
                  e.classList.remove("current", "on-show", "on-view", "isview");
                }),
                ...
                gsap.to([".colum-box-news", ".scrollB"], {
                  duration: 0.5,
                  ease: "none",
                  opacity: 0,
                  onComplete: function () {
                ...
                gsap.to(".news-content", {
                  ...
                  onComplete: function () {
                    (document
                      ...
                      .classList.remove("hide", "show-list"),
                      document.querySelector(".news-text") &&
                      document.querySelector(".news-text").remove(),
                      document
                        .querySelector(".news-content")
                        .classList.remove("show"),
                      document
                        .querySelector(".colum-box-news")
                        .classList.remove("show"),
                      document
                        .querySelector(".wrap-view-more")
                        .classList.remove("show"),
                      Mobile.matches && onScroll());
                  },
                }));
            }));
      }
...
function ApartmentLoad(e, t, o, s, a, n) {
  ...
  (r.open("GET", e, !0),
    (r.onreadystatechange = function () {
      if (4 == r.readyState && 200 == r.status) {
        if (
          ((houseLoad.innerHTML = r.responseText),
            !document.getElementById("key_js"))
        ) {
          var e = document.createElement("script");
          ((e.id = "key_js"),
            (e.src = httptemplate + "js/modules/" + s + ".js"),
            houseLoad.prepend(e));
        }
        if (!document.querySelector(".slide-pic-nav")) {
          var c = document.createElement("div");
          ((c.className = "slide-pic-nav"),
            c.setAttribute("data-id", "filter-text"),
            (c.innerHTML =
              '<div class="next-pic"></div><div class="prev-pic"></div>'),
            loadApartment.append(c));
        }
        (bgHouse.classList.add("show"),
          (houseLoad.querySelector(".floor-block .floor-num").innerHTML = t),
          (houseLoad.querySelector(".floor-block .block-num").innerHTML = o),
          (houseLoad.querySelector(".block-code .add-class").innerHTML = a),
          (houseLoad.querySelector(".keyplan .block-num").innerHTML = o),
          document
            .querySelectorAll(".next-pic, .prev-pic, .house-detail .share a")
            .forEach(function (e) {
              buttonEF && new buttonEF(e);
            }),
          ShareSocial());
        var l = document.querySelector(".house-text.current");
        (l && LoadNext(l),
          gsap.to(houseLoad, {
            duration: 0.3,
            ease: "none",
            opacity: 1,
            onComplete: function () {
              if (!document.querySelector(".keyplan-svg")) {
                var e = document.createElement("div");
                ((e.className = "keyplan-svg"),
                  (e.innerHTML = KeyFloor),
                  document.querySelector(".keyplan").append(e));
              }
              (gsap.to(".keyplan-svg", {
                duration: 0.3,
                ease: "none",
                ...
                onComplete: function () {
                  for (
                    var e = houseLoad.querySelectorAll(
                  ...
                  var o = houseLoad.querySelector(
                    '.keyplan-svg .key-area[data-num="' + n + '"]',
                  );
                  null !== o &&
                ...
                houseLoad.classList.add("show"),
                loadApartment
                  .querySelector(".slide-pic-nav")
                  .classList.add("show"),
                closeApart.classList.add("show"),
                Mobile.matches ? onScroll() : Pat.Play(),
                Loadx.classList.remove("display-block"));
            },
          }),
          closeApart.addEventListener("click", function (e) {
            ...
            return (
              ...
              Mobile.matches
                ? (addURL(
                  document.querySelector(".nav-item.current a"),
                  document.querySelector(".nav-item.current a").dataset.name,
                ),
                  changeAlternate(
                    document.querySelector(".nav-item.current a").href,
                    document.querySelector(
                      ".nav-item.current .link-change-url",
                    ),
                    1,
                  ))
                : (addURL(
                  document.querySelector(".box-nav-button.current button"),
                  document.querySelector(".box-nav-button.current button")
                    .dataset.page,
                ),
                  changeAlternate(
                    document.querySelector(".box-nav-button.current button")
                      .dataset.href,
                    document.querySelector(
                      ".box-nav-button.current .link-change-url",
                    ),
                    1,
                  )),
              document.querySelector("#key_js") &&
              document.querySelector("#key_js").remove(),
              ...
              gsap.to([loadApartment, houseLoad], {
                ...
                onComplete: function () {
                  ((houseLoad.innerHTML = ""),
                    ...
                    Body.classList.remove("no-scroll", "light-color"),
                    HTML.classList.remove("no-scroll"));
                },
              }),
              !1
          ...
          window.addEventListener("resize", function () {
            Mobile.matches ? (onScroll(), Pat.Pause()) : Pat.Play();
          }));
      }
    }),
...
function LoadNext(e) {
  var t = !1,
    ...
    s = document.querySelector(".on-slide .current").previousElementSibling,
    a = document.querySelectorAll(".on-slide .house-text"),
    n = a.length,
    r = document.querySelector(".on-slide .current"),
    c = document.querySelector(".next-pic"),
    l = document.querySelector(".prev-pic");
  (checkNum(n, r),
    document.querySelector(".next-pic").addEventListener("click", function (e) {
      (e.preventDefault(),
        e.stopPropagation(),
        (t = !0),
        document.querySelector(".next-pic").classList.add("disabled"));
      for (var s = 0; s < a.length; s++) a[s].classList.remove("current");
      return (
        houseLoad.classList.remove("show"),
        houseLoad.querySelector(".house-detail").classList.remove("show-house"),
        Loadx.classList.contains("display-block") ||
          ...
          onComplete: function () {
            if (
              (document.querySelector(".house-detail") &&
                (houseLoad.innerHTML = ""),
                (t = !1),
                o && (o.classList.add("current"), o.querySelector(".go-link")))
            ) {
              var e = o.querySelector(".go-link").href,
                s = o.parentNode.parentNode.dataset.floors,
                a = o.parentNode.dataset.text,
                n = o.parentNode.parentNode.dataset.key,
                r = o.querySelector(".num-block").textContent,
                c = o.dataset.num;
              (addURL(
    ...
    document.querySelector(".prev-pic").addEventListener("click", function (e) {
      (e.preventDefault(),
        e.stopPropagation(),
        (t = !0),
        document.querySelector(".prev-pic").classList.add("disabled"));
      for (var o = 0; o < a.length; o++) a[o].classList.remove("current");
      return (
        houseLoad.classList.remove("show"),
        houseLoad.querySelector(".house-detail").classList.remove("show-house"),
        Loadx.classList.contains("display-block") ||
          ...
          onComplete: function () {
            if (
              (document.querySelector(".house-detail") &&
                (houseLoad.innerHTML = ""),
                (t = !1),
                s && (s.classList.add("current"), s.querySelector(".go-link")))
            ) {
              var e = s.querySelector(".go-link").href,
                o = s.parentNode.parentNode.dataset.floors,
                a = s.parentNode.dataset.text,
                n = s.parentNode.parentNode.dataset.key,
                r = s.querySelector(".num-block").textContent,
                c = s.dataset.num;
              (addURL(
                s.querySelector(".go-link"),
                s.querySelector(".go-link").dataset.name,
              ),
                changeAlternate(
                  s.querySelector(".go-link").href,
                  s.querySelector(".link-change-url"),
                  1,
                ),
                ApartmentLoad(e, o, a, n, r, c));
            }
          },
        }),
        !1
      ...
      function (e) {
        if (!Mobile.matches) {
          ...
          if (Math.max(-1, Math.min(1, e.wheelDelta || -e.detail)) > 0) {
            if (!doWheel || t) return;
            ((doWheel = !1),
              l.classList.contains("disabled") || l.click(),
...
function popupLoad(e) {
  document.querySelector(".popup") &&
    (document.querySelector(".popup").remove(),
      document.querySelector(".close-popup").remove());
  var t = window.XMLHttpRequest
    ? new XMLHttpRequest()
    : new ActiveXObject("Microsoft.XMLHTTP");
  (t.open("GET", e, !0),
    (t.onreadystatechange = function () {
      if (4 == t.readyState && 200 == t.status) {
        ((document.querySelector(".popup-details .news-content").innerHTML =
          (function () {
            var parser = new DOMParser();
            var doc = parser.parseFromString(t.responseText, "text/html");
            var loadedContent = doc.querySelector(".news-content");
          ...
          document
            .querySelector(".popup-details")
            .classList.remove("display-none"));
        var e = document.createElement("button");
        ((e.className = "close-popup"),
          e.setAttribute("aria-label", "close"),
          document.querySelector(".popup-details").append(e),
          lazyLoadInstance.update(),
          onScroll(),
          document.querySelector(".popup-details form") && FocusText(),
          document.querySelector(".text-ani-item") &&
          Splitting({ target: ".text-ani-item", by: "chars" }),
          document.querySelector(".title-main h2") &&
          Splitting({ target: ".title-main h2", by: "chars" }),
          document
            .querySelectorAll(".news-text a, .news-text p a")
            .forEach(function (e) {
              e.addEventListener("click", function (e) {
          ...
          document.querySelector(".click-hover").classList.add("show"));
        var o = function () {
          document.querySelector(".news-text").offsetHeight > window.innerHeight
            ? document.querySelector(".scroll-popup").classList.add("no-after")
            : document
              .querySelector(".scroll-popup")
              .classList.remove("no-after");
        };
        (window.addEventListener("resize", function () {
          document.querySelector(".news-text") && o();
        }),
          gsap.to(".news-content", {
            duration: 0.5,
            opacity: 1,
            ease: "none",
            onComplete: function () {
              (document.querySelector(".popup-details").classList.add("show"),
                document.querySelector(".close-popup").classList.add("show"),
                document.querySelector(".popup").classList.add("show"));
              var e = document.querySelector(".news-content");
              (setTimeout(function () {
                (aniText(e), e.classList.add("show"));
              }, 500),
                document.querySelector(".news-text") && o(),
                Loadx.classList.remove("display-block"));
            },
          }));
        var s = document.querySelector(".close-popup");
        (new buttonEF(s),
          s.addEventListener("click", function (e) {
            return (
              ...
              gsap.to(".news-content", {
                ...
                onComplete: function () {
                  ((document.querySelector(
                    ".popup-details .news-content",
                  ).innerHTML = ""),
                    document
                      .querySelector(".click-hover")
                      .classList.remove("show"),
                    document
                      .querySelector(".popup-details")
                      .classList.remove("show"),
                    ...
                    overlayDark.classList.remove("other"),
                    Body.classList.remove("no-scroll"),
                    HTML.classList.remove("no-scroll"),
                    s.remove(),
                    setTimeout(function () {
...
function ContentLoad() {
  ...
  if (
    (newsPage &&
      mainMenu.querySelector(".nav-item.current") &&
      (mainMenu.querySelector(".nav-item.current").classList.add("active"),
        mainMenu.querySelector(".nav-item.current").classList.remove("current")),
      document.querySelector(".popup-show") &&
      setTimeout(function () {
        var e = document.querySelector(".popup-show").dataset.href;
        (Body.classList.add("no-scroll"),
          HTML.classList.add("no-scroll"),
          overlayDark.classList.remove("display-none"),
          setTimeout(function () {
            overlayDark.classList.add("show", "other");
          }, 200),
          popupLoad(e));
      }, 3e3),
      homePage ||
      (Logo.classList.add("cursor"),
        Logo.addEventListener("click", function (e) {
          (e.preventDefault(), document.querySelector(".link-home").click());
        }),
        Body.classList.remove("no-scroll"),
        HTML.classList.remove("no-scroll"),
      ...
      aboutPage &&
      (Logo.classList.add("space"),
        Mobile.matches
          ? document
            .querySelector(".about-overview .slide-inner")
            .append(logoBanner)
          : (logoBanner.classList.add("show"),
            goDown.classList.add("show"),
            Loop.play())),
      locationPage &&
      (Logo.classList.add("show", "space"),
        Mobile.matches || goDown.classList.add("show"),
        document.querySelector(".location .map-svg").classList.add("show"),
        hoverEvents(),
        MapZoom()),
      facilitiesPage)
  ) {
    if ((Logo.classList.add("show", "scale-logo"), !Mobile.matches)) {
      goDown.classList.add("show");
      var e = document.querySelector(".floor-01 .scrollA");
      ...
      var t = document.querySelectorAll(".scrollA");
      gsap.to(t, { duration: 0.1, scrollTop: 0, scrollLeft: 0, ease: "none" });
    }
    hoverEvents();
  }
  if (apartmentPage || document.querySelector(".masterplan")) {
    if (apartmentPage) {
    ...
    if (!Mobile.matches) {
      ...
      var o = document.querySelectorAll(".svg-b");
      document.querySelectorAll(".hover-b").forEach(function (e) {
        (e.addEventListener("mouseenter", function () {
          var e = this.dataset.block;
          document
            .querySelector('.svg-b[data-block="' + e + '"]')
          ...
          e.addEventListener("click", function (e) {
            ...
            if (!Mobile.matches)
              if (
                document.querySelector(
                  ".box-nav li .click[data-page='" + t + "']",
                )
              )
                document
                  .querySelector(".box-nav li .click[data-page='" + t + "']")
                  .click();
              else {
                var o = document.querySelector(
                  ".box-nav li.current",
                ).nextElementSibling;
                o && o.querySelector(".click").click();
              }
          }));
      });
    }
    var s = document.querySelectorAll(".text-faci .text"),
      a = document.querySelectorAll(".house-text"),
      n = document.querySelectorAll(".block-area");
    if (
      (a.forEach(function (e) {
        e.addEventListener("click", function (e) {
          e.preventDefault();
          for (var t = 0; t < n.length; t++) n[t].classList.remove("show");
          for (t = 0; t < a.length; t++)
            a[t].classList.remove("show", "current");
          for (t = 0; t < s.length; t++) s[t].classList.remove("active");
          (this.classList.add("current"),
            this.parentNode.classList.add("on-slide"));
          var o = this.querySelector(".go-link").href,
            r = this.parentNode.parentNode.dataset.floors,
            c = this.parentNode.dataset.text,
            l = this.parentNode.parentNode.dataset.key,
            i = this.querySelector(".num-block").textContent,
            u = this.dataset.num;
          return (
            Body.classList.add("no-scroll", "light-color"),
            HTML.classList.add("no-scroll"),
        ...
        n.forEach(function (e) {
          (addMultipleEvents(["mouseenter", "click"], e, function (e) {
            if (!Mobile.matches) {
              ...
              var t = this.parentNode.dataset.block,
                o = this.dataset.num,
                s = e.clientX,
                a = e.clientY;
              document
                .querySelector(".text-faci .text[data-block='" + t + "']")
                .classList.add("active");
              var n = document.querySelector('.house-text[data-num="' + o + '"]');
              n &&
                ((n.style.left = s + 40 + "px"),
                  (n.style.top = a - 100 + "px"),
                  n.classList.add("show"));
            }
          }),
            e.addEventListener("mouseleave", function (e) {
              this.classList.remove("show");
              for (var t = 0; t < s.length; t++) s[t].classList.remove("active");
              for (t = 0; t < a.length; t++) a[t].classList.remove("show");
            }),
            e.addEventListener("click", function (e) {
              e.preventDefault();
              var t = this.dataset.num;
              return (
                document
                  .querySelector(".house-text[data-num='" + t + "']")
                  .click(),
                !1
              );
            }));
        ...
        document.querySelector(".click-nav"))
    ) {
      ...
      var r = document.querySelectorAll(".click-nav");
      r.forEach(function (e) {
        e.addEventListener("click", function (e) {
          (e.preventDefault(), RemoveClass(r));
          var t = this.dataset.page;
          this.classList.add("current");
          var o = document.querySelector(
  ...
  if (
    ((libraryPage || document.querySelector(".pic-library")) &&
      (Logo.classList.add("show", "space"),
        Mobile.matches || goDown.classList.add("show"),
        document.querySelectorAll(".pic-library").forEach(function (e) {
          e.addEventListener("click", function (e) {
            (e.preventDefault(),
              Mobile.matches && this.querySelector("a").click());
          });
        })),
      newsPage || document.querySelector(".news"))
  ) {
    ...
    var l = document.querySelectorAll(".link-page");
    (l.forEach(function (e) {
      e.addEventListener("click", function (e) {
        ...
        return (
          ...
          document.querySelector(".colum-box-news").classList.add("show"),
          document.querySelector(".wrap-view-more").classList.add("show"),
          document.querySelector(".news-content .scrollC") &&
          (document.querySelector(".news-content").innerHTML = ""),
          Loadx.classList.contains("display-block") ||
          Loadx.classList.add("display-block"),
          Mobile.matches &&
          (gsap.to("html", { duration: 0.4, scrollTop: 0, ease: "expo.out" }),
            gsap.to([".colum-box-news", ".scrollB"], {
              duration: 0.5,
              ease: "none",
              opacity: 0,
          ...
          gsap.to(".news-content", {
            ...
            onComplete: function () {
              (document
                .querySelector(".news-list")
                .classList.add("hide", "show-list"),
                NewsLoad(o));
            },
          }),
          addURL(this.querySelector(".view-news"), t),
          !1
        );
      });
    }),
  ...
  if (progressPage || document.querySelector(".progress")) {
    ...
    var i = document.querySelector(".select-header"),
      ...
      d = document.querySelectorAll(".select-box li"),
      m = document.querySelectorAll(".select-box li a");
    (i.addEventListener("click", function (e) {
      ...
      document
        ...
        .addEventListener("mouseleave", function () {
          gsap.to(".select-box", {
            ...
            opacity: 0,
            onComplete: function () {
              (i.classList.remove("onclick"), u.classList.remove("show"));
            },
          });
        }),
      m.forEach(function (e) {
        e.addEventListener("click", function (e) {
          e.preventDefault();
          for (var t = 0; t < d.length; t++) d[t].classList.remove("selected");
          ...
          var o = this.dataset.month,
            s = this.href,
            a = this.querySelector("h3").textContent;
          return (
            (document.querySelector(".select-header h3").innerHTML = a),
            document.querySelector(".progress-list").classList.remove("show"),
            document
              .querySelector(".progress .title-main h2")
              .classList.remove("words", "chars", "splitting"),
            (document.querySelector(".progress .title-main h2").style = ""),
            Loadx.classList.contains("display-block") ||
            Loadx.classList.add("display-block"),
            1 == isFirst &&
            (addURL(this, o),
              changeAlternate(
                this.href,
                this.parentNode.querySelector(".link-change-url"),
                1,
              )),
            (isFirst = 1),
            gsap.to(".progress-list", {
      ...
      document.querySelector(".select-box li.selected")
        ? document.querySelector(".select-box li.selected a").click()
        : document.querySelector(".select-box li:first-child") &&
        document.querySelector(".select-box li:first-child a").click());
  }
  (contactPage &&
    (Logo.classList.add("show", "space"),
      Footer.classList.add("show", "align-left"),
      rightHeader.classList.add("hide-subscribe"),
      Register &&
...
if (Pattern) {
  var Pat = new Patterns();
  Pat.Pause();
}
function listAni(e, t, o) {
  return gsap
    .timeline()
    .to(e, { x: o, duration: t, ease: "none", repeat: -1, paused: !1 });
}
var Loop = gsap.timeline().add(listAni(".move-img", 30, "-290%"));
function ShareSocial() {
  var e = document.querySelector(".share-facebook");
  if (e) {
    var t =
...
function Done() {
  ...
  (document
    .querySelectorAll(
      ".effect,.icon,.box-nav li,.active-nav,.close-nav,.close,.close-apartment,.button,.view-more,.social li,.view-album,.view-video,.download-pdf,.more-news",
    )
    .forEach(function (e) {
      if (!Mobile.matches && !Touch) {
        buttonEF && new buttonEF(e);
      }
    }),
    document.querySelectorAll(".block.disable-block").length > 0 &&
    document.querySelectorAll(".block.disable-block").forEach(function (e) {
      var t = e.dataset.block;
      document
        .querySelectorAll("div[data-block=" + t + "]")
        .forEach(function (e) {
          e.classList.add("disable-block");
        });
    }));
}
function swapMask() {
  ...
  (document.querySelector(".load-effect").classList.add("out"),
    t
      ? (gsap.set(".vector-mask", {
        attr: { "xlink:href": httptemplate + "images/mask_1L.svg" },
      }),
        e.to(".mask-landscape", {
          duration: 1,
          y: -10620,
          ...
          stagger: -0.3,
          onComplete: function () {
            (Done(), document.querySelector(".load-effect").remove());
          },
        }))
      : (gsap.set(".vector-mask", {
        attr: { "xlink:href": httptemplate + "images/mask_1P.svg" },
      }),
        e.to(".mask-portrait", {
          duration: 1,
          x: -10620,
...
(Loop.pause(),
    ...
    debounce(function () {
      if ((ResizeWindows(), Mobile.matches)) {
        if (homePage) {
          ...
          ("vi" == HTML.lang ? aniText(TaglineVI) : aniText(TaglineEN),
            document.querySelectorAll(".layout-move").forEach(function (e) {
            ...
            (Header.classList.remove("show-head", "show"),
              logoCenter.classList.add("show"),
              Wave.Play()),
            "vi" == HTML.lang
              ? TaglineVI.classList.contains("show") ||
              (TaglineVI.classList.add("show"),
                goDown.classList.add("show", "center-align"))
              : TaglineEN.classList.contains("show") ||
              (TaglineEN.classList.add("show"),
                goDown.classList.add("show", "center-align")));
        }
        (aboutPage &&
          null == document.querySelector(".about-overview .logo-banner") &&
          document
            .querySelector(".about-overview .slide-inner")
            .append(logoBanner),
          (newsPage || document.querySelector(".news")) &&
  ...
  window.addEventListener("load", function () {
    (document.querySelector(".slide-logo") && logoSlide(),
      document.querySelector(".list-logo") && listSlide(),
      document.querySelector(".slide-library") && librarySlide());
  }),
  history.pushState &&
  (window.onpopstate = function (e) {
    ...
    (null != document.querySelector(".close-video") &&
      ...
      document.querySelector("#news-page") &&
      document.querySelectorAll(".view-news").forEach(function (e) {
        e.href == t && e.click();
      }),
      document.querySelector("#progress-page") &&
      document.querySelectorAll(".select-box li a").forEach(function (e) {
        e.href == t && e.click();
      }),
      (document.querySelector("#apartment-page") || document.querySelector("#home-page")) &&
      (null != document.querySelector(".house-detail")
        ? document.querySelector(".close-apartment").click()
        : document.querySelectorAll(".go-link").forEach(function (e) {
          e.href == t && e.click();
        })),
      document.querySelectorAll(".box-nav li button").forEach(function (e) {
